...
import com.booxj.opensource.mine.apollo.sample.property.spring.config.ConfigChangeListener;
...
public class AutoUpdateConfigChangeListener implements ConfigChangeListener {
    ...
    private static Logger logger = LoggerFactory.getLogger(AutoUpdateConfigChangeListener.class);
    ...
    public AutoUpdateConfigChangeListener(ConfigurableEnvironment environment, ConfigurableListableBeanFactory beanFactory) {
